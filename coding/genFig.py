...
with pymp.Parallel(3) as p:
    for epoch in p.range(10,432):
        ...
        for i in range(start,stop):
            ...
            curlax.scatter3D(sample_curl[keep1,i:i+1,0], sample_curl[keep1,i:i+1,1], sample_curl[keep1,i:i+1,2],c=nco[keep1,i:i+1],s=1)
        ...
        curlax.set_title(f"BaseCase Curl of output dimension, Epoch {epoch} Accy:{accy.loc[epoch]['Accy']} \n ValidationSet (1000 Samples) ColorMap=Positive/Negative Sentiment")
        plt.tight_layout()
