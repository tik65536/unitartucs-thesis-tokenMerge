...
\begin{figure} [!h]
\begin{center}
\includegraphics[width=0.4\textwidth]{figures/prepareMerge.png}
...
The architecture for the model consists of 4 main blocks which are Embedding, Merge, LSTM, and classification. The following table(\ref{tab:modelsettings}) and diagram give a summary and visualization of parameters setting for those blocks:
\begin{table}[!h]
\begin{tabular}{|c|l|}
\hline
