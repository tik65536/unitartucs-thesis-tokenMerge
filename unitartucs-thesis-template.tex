...
The false-belief test is one step further based on the above tasks which include differences in the mental state of participants and the character in the story{cite}. In this type of experiment, participants are usually given a storyboard that shows a particular event that is known to the participants but not 
...
are asked based on the material given to access the understanding of  
