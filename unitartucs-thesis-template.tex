...
In this formulation, the study of linguistics focuses on inferring the mechanism(mental grammar\cite{Gallego_2022}) of  I-language by observing external language that is generated by internal language and formulates the grammar in daily use. 
The relationship between grammar, I-language, and E-language can be visualized below (fig:\ref{fig:ilanguage}) \cite{Mark_2006}:
\begin{figure} [ht]
\begin{center}
\includegraphics[width=0.5\textwidth]{figures/iLanguage_eLanguage.png}
\caption{relationship between Grammar, I-language and E-language.}
\label{fig:ilanguage}
\end{center}
\end{figure}
One observation of the external language is its property on an infinite set of expressions which implies that the I-language holds an abstract structure behind the scenes and plays a crucial role in giving out meaningful sentiment,  not the ordering or arrrangement of words  
