...
With all those components described above, this thesis hypothesis that the learning dynamic for those LLM can be described by the following diagram in a top-level view.
\begin{figure} [!h]
\begin{center}
\includegraphics[width=0.2\textwidth]{figures/Ilang_Elang_NLU_NLG.png}
\caption{} 
\label{fig:bps}
\end{center}
\end{figure}
